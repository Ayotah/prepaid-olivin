(function() {
    try {
        ...
        ! function(O) {
            ...
            var p, t, W = "OneTag",
                N = ["color: #fff;", "background: #ff4f00;", "display: inline-block;", "padding: 1px 4px;", "border-radius: 3px;"].join(" "),
                R = ((b = p = p || {})[b.Off = 0] = "Off", b[b.Error = 1] = "Error", b[b.Warning = 2] = "Warning", b[b.Info = 3] = "Info", b[b.Debug = 4] = "Debug", a.setLogLevel = function(e) {
                    a.level = e, this.debug("Log level set to " + p[e])
                }, a.setUseHeader = function(e) {
                    this.useHeader = e
                }, a.debug = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    a.log(console.log, p.Debug, e)
                }, a.info = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    a.log(console.log, p.Info, e)
                }, a.warn = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    a.log(console.warn, p.Warning, e)
                }, a.error = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    a.log(console.error, p.Error, e)
                }, a.log = function(e, t, n) {
                    t <= a.level && (t = 0 < (t = window.navigator.userAgent).indexOf("MSIE ") || 0 < t.indexOf("Trident/") ? ["[" + W + "]"] : ["%c" + W, N], e.apply(console, this.useHeader ? t.concat(n) : n))
                }, a.level = p.Warning, a.useHeader = !0, a);

            function a() {}(b = t = t || {})[b.Unknown = 0] = "Unknown", b[b.TopLevel = 1] = "TopLevel", b[b.Child = 2] = "Child";
            ...
            }, s.getOneTagLocation = function() {
                try {
                    return window.self === window.top ? t.TopLevel : t.Child
                } catch (e) {
                    return R.info("Cannot get OneTag location", e), t.Unknown
                }
            }, s.isChrome = function() {
            ...
            var f, G = "5.37.0",
                g = ((b = f = f || {})[b.None = 0] = "None", b[b.Cookie = 1] = "Cookie", b[b.LocalStorage = 2] = "LocalStorage", b[b.Library = 3] = "Library", c.checkLocalStorageIsWritable = function() {
                    try {
                        var e, t, n;
                ...
                }, c.checkCookiesAreWritable = function() {
                    var e = new c("criteo_write_test", 1e4),
                        t = (e.setValueWithNoDomain("1"), "1" === e.cookieValue);
                    return e.removeWithNoDomain(), t
                }, c.prototype.setCookieRead = function() {
                    this.isCookieRead = !0
                ...
                }, c.prototype.setValueFromExistingCookie = function() {
                    var e = this.getValue();
                    void 0 !== e && (this.cookieValue = e, this.cookieExtractor = {
                        origin: f.Cookie
                    })
                }, c.prototype.setValueFromAllStorages = function() {
                ...
                }, c.prototype.removeFromAllStorages = function() {
                    this.removeOnMainDomain(), this.tryRemoveFromLocalStorage()
                }, c.prototype.setValueWithNoDomainWithExpiration = function(e, t) {
                    var n = new Date,
                ...
                }, c.prototype.setValueWithNoDomain = function(e) {
                    this.setValueWithNoDomainWithExpiration(e, this.cookieRetentionTimeInMs)
                }, c.prototype.toFragmentData = function() {
                    return {
                        identifierExtractor: this.cookieExtractor,
                        value: this.cookieValue
                    }
                }, c.prototype.setOnMainDomainWithExpiration = function(e, t) {
                ...
                }, c.prototype.computeStorageOrigin = function(e, t) {
                    var n = f.None;
                    return e && (n |= f.Cookie), t && (n |= f.LocalStorage), n
                }, c.prototype.getMatchingKeyInAllStorage = function(e) {
                    ...
                    return ""
                }, c.prototype.tryReadFromLocalStorage = function() {
                    var e, t;
                    try {
                ...
                }, c.prototype.tryRemoveFromLocalStorage = function() {
                    try {
                        return window.localStorage ? (window.localStorage.removeItem(this.cookieName), !0) : !1
                    } catch (e) {
                        return !1
                    }
                }, c.prototype.tryWriteInLocalStorage = function(e) {
                    var t, n;
                    try {
            ...
            function v(e) {
                this.useStaticConsentForId5 = e, this.logger = function() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    return R.debug.apply(R, i(["[ID5]"], e))
            ...
            function I() {
                var t = this;
                this.lastValue = I.unsetValue, this.hasValue = new Promise(function(e) {
            ...
            function ne(e, t) {
                ...
                this.tcfCompatibleConsentProvider = new J(new Y(e, s, R.info), new $(e, s, R.info), R.info), this.ccpaConsentProvider = new X(e, a, R.info), this.gppConsentProvider = new Z(e, i, R.info), this.consentWrapper = new ee, this.updateConsent(), e.setInterval(function() {
            ...
            function ie(e) {
                var t = new URLSearchParams,
                    n = e.gdprConsent,
                    n = (n && (void 0 !== n.gdprApplies && t.set("gra", n.gdprApplies ? "1" : "0"), void 0 !== n.consentData && t.set("grs", n.consentData), void 0 !== n.version) && t.set("grv", n.version.toString()), e.ccpaConsent),
                    n = (n && (void 0 !== n.uspString && t.set("cs", n.uspString), void 0 !== n.version) && t.set("cv", n.version.toString()), e.gppConsent),
                    e = (n && (void 0 !== n.gpp && t.set("gpp", n.gpp), void 0 !== n.gppSid) && n.gppSid.forEach(function(e) {
                        t.append("gpp_sid", e.toString())
                    }), ! function() {
                        for (var e = document.cookie.split(";"), t = [], n = 0, i = e; n < i.length; n++) {
                            var o = i[n],
                                o = o.slice(0, o.indexOf("=")).trim();
                            o.toLowerCase().includes("consent") && t.push(o)
                        }
                        return t
                    }().forEach(function(e) {
                        t.append("consent_cookie", e)
                    }), t.toString());
                return e ? e.split("&") : []
            }
            ...
            function D(e, t) {
                if (void 0 !== e || void 0 !== t) {
                    ...
                    if (!(e instanceof Array)) return D([e], t);
                    if (!(t instanceof Array)) return D(e, [t]);
            ...
            function _(e) {
                var t = e;
                if (e instanceof Function) return (t = e()) instanceof Function ? t : _(t);
                if (e instanceof Array)
                    for (var t = [], n = 0; n < e.length; ++n) t[n] = _(e[n]);
            ...
            function se(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && D(t.account, o.account)) {
            ...
            function ce(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && D(t.account, o.account) && o.hash_method === t.hash_method) return void(void 0 !== t.email && (o.email = function(e, t) {
                        var n = [];
            ...
            function A(e, t, n) {
                n = _(n);
                return ue(e, n), se(t, _(n)), 1
            }

            function ue(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && void 0 === t.account && void 0 === o.account || D(t.account, o.account)) {
                        for (var r in t) t.hasOwnProperty(r) && "account" !== r && (o[r] = t[r]);
                        return
                    }
                }
            ...
            F.prototype.fillQueryStringParams = function(e, t) {
            ...
            }, F.prototype.checkAcid = function() {
                this.setCanWriteCookie(), this.setCanWriteLocalStorage()
            }, F.prototype.setCop = function(e) {
            ...
            }, F.prototype.scrapIdentifiers = function(i) {
            ...
            }, F.prototype.getParameterValueByName = function(e, t) {
                if (e && 1 < e.length) {
                    var n, t = "&" + t + "=",
            ...
            E.prototype.fillQueryStringParams = function(e, t) {}, E.prototype.checkAcid = function() {}, E.prototype.setCop = function(e) {}, E.prototype.checkClientSideIdentityStatus = function() {}, E.prototype.checkCookies = function(e) {}, E.prototype.scrapIdentifiers = function(e) {
                return ""
            };
            var ve = E;
            ...
            Ce.prototype.createIframe = function(e, t, n, i, o) {
                ...
                return a && void 0 !== a.uspString && (i += "&us_privacy=" + a.uspString), i += "#" + JSON.stringify(t), r.src = i, r.id = this.gumSyncFrameId, h("styleIframes", !(r.hidden = !0)) && (r.style.display = "none"), r.setAttribute("sandbox", "allow-scripts allow-same-origin"), r.setAttribute("aria-hidden", "true"), r.title = "Criteo GUM iframe", d.removeLater(n, r), r
            ...
            var ke = new RegExp(/^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i),
                Pe = (x.prototype.canRetrieveMetrics = function() {
            ...
            function De(e, t, n, i, o) {
                var r, a, s, c;
                return document && window.location.hash && (a = Re.exec(window.location.hash)) && 4 === a.length && (r = "enable" === a[1], a = Number(a[3]), new g("criteoTagDebugMode", r ? 864e5 : 0).setValueWithNoDomain(r && a && !isNaN(a) ? String(a) : "0"), window.location.href = window.location.href.substr(0, window.location.href.indexOf("#"))), document && "function" == typeof Array.prototype.indexOf && -1 !== document.cookie.indexOf("criteoTagDebugMode=") ? (s = o, c = {
            ...
            function _e(n, i) {
                function e(t) {
                    return void 0 === t && (t = !1), u(o, void 0, void 0, function() {
                        return T(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return i.eventSent ? [3, 4] : t ? [4, n.pushInternal({
                ...
                var o = this,
                    t = (window.addEventListener && window.addEventListener("pagehide", function() {
                        return e(!0)
            ...
            L.prototype.push = function() {
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return T(this, function(e) {
                        ...
                        switch (f.event) {
                            case "setdata":
                                return [2, A(o.extraData, t.actions, f)];
                            case "setparameter":
                            ...
                            case "setzipcode":
                            case "setstore":
                                return f.event = "setdata", [2, A(o.extraData, t.actions, f)];
                            case "setcustomerid":
                                return f.event = "setdata", f.customer_id = f.id, delete f.id, [2, A(o.extraData, t.actions, f)];
                            case "setretailervisitorid":
                                return n.enable(), f.event = "setdata", f.retailer_visitor_id = f.id, delete f.id, [2, A(o.extraData, t.actions, f)];
                            case "setgoogleadvertisingid":
                                return i.gaid = f.gaid, [2, A(o.extraData, t.actions, {
                                    event: "setdata",
                                    site_type: "aa"
                                })];
                            case "setappleadvertisingid":
                                return i.idfa = f.idfa, [2, A(o.extraData, t.actions, {
                                    event: "setdata",
                                    site_type: "aios"
                                })];
                            case "setemail":
                            case "sethashedemail":
                            case "ceh":
                                return f.event = "setemail", f.hasOwnProperty("email") && (f.email instanceof Array || (f.email = [f.email]), f.email = ae(f.email)), l = _(f), o.customerInfo.push(l), ce(t.actions, _(f)), [2, 1];
                            case "setphonenumber":
                            case "setsha256hashedphonenumber":
                                ...
                                }, delete f.phone_number, f.event = "setIdentity", f.identity = [d], t.actions.push(_(f)), [2, 1]) : [2, 0];
                            case "setidentity":
                                return f.hasOwnProperty("identity") && 0 < (d = ae(f.identity instanceof Array ? f.identity : [f.identity])).length ? (f.identity = d, t.actions.push(_(f)), [2, 1]) : [2, 0];
                            case "setsitetype":
                                return h = "d", "aios" !== f.type && "aa" != f.type || (h = f.type), "mobile" !== f.type && "m" !== f.type || (h = "m"), "tablet" !== f.type && "t" !== f.type || (h = "t"), f.event = "setdata", delete f.type, f.site_type = h, [2, A(o.extraData, t.actions, f)];
                            case "appendtag":
                        ...
                        return t.actions.push(_(f)), [2, 1]
                    })
                })
            }, L.prototype.flush = function(I) {
                return u(this, void 0, void 0, function() {
                    var i, o, r, a, s, c, u, l, p, d, h, f, g, m, v, y, C, w, b, k, P, S;
                    return T(this, function(e) {
                        switch (e.label) {
                            case 0:
                                if (i = this.mState.app, o = this.mState.cbs, r = this.mConfig.trackingCallData, a = this.mConfig.workflow, (s = this.mConfig.hooks).onFlush instanceof Function && (s.onFlush(), R.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")), 0 === i.actions.length) return [2];
                                for (c = 0, u = r.extraData; c < u.length; c++) l = u[c], se(i.actions, l);
                                for (p = 0, d = r.customerInfo; p < d.length; p++) h = d[p], ce(i.actions, h);
                                for (f = 0, g = i.actions; f < g.length; f++) m = g[f], (n = void 0) !== (t = m).identity && JSON.stringify && (n = t.identity instanceof Array ? t.identity : [t.identity], t.raw_identity = JSON.stringify(n), delete t.identity);
                                if (!a.manualDising && (!I || a.partialDis)) {
                                    for (v = [], y = 0, C = i.accounts; y < C.length; y++) w = C[y], re(i.disingScheduled, w) || v.push(w);
                                    0 < v.length && this.evalCallDisingEvent({
                                        event: "callDising",
                                        account: v
                                    })
                                }
                                return b = this.getQueryParams(), i.actions = [], [4, this.mConsentManager.retrieveConsent()];
                            case 1:
                                return k = e.sent(), b.push.apply(b, ie(k)), [4, o.tryAdBlockDetection(500)];
                            case 2:
                                if (e.sent(), !(r.isStepAllowed("readCmaTestLabel") && "cookieDeprecationLabel" in navigator)) return [3, 6];
                                e.label = 3;
                            case 3:
                                return e.trys.push([3, 5, , 6]), [4, navigator.cookieDeprecationLabel.getValue()];
                            case 4:
                                return k = e.sent(), b.push("cl=" + k), [3, 6];
                            case 5:
                                return e.sent(), [3, 6];
                            case 6:
                                return o.tryAppendAdBlockerParameter(b), P = this.generateQueryString(b), S = this.buildHandlerCall(P), "function" == typeof s.onUrlGenerated ? s.onUrlGenerated(S.url) : "beacon" === r.requestType && navigator.sendBeacon ? navigator.sendBeacon(S.url) : this.evalAppendTagEvent(S), R.info("DIS call triggered", S.url, b), (i.eventSent = !0) === S.isImgUrl && this.mAttributionReporting.registerTrigger(P), a.disOnce || (i.disingScheduled = []), [2]
                        }
                        var t, n
                    })
                })
                ...
                }), e.event = e.event.toLowerCase(), null) : (_(e), 1))
                ...
                if (!this.mState.app.bodyReady || t.container && document.body.contains(t.container) || (t.container = d.appendCriteoContainer(document.body)), e.url && (n = void 0, e.isImgUrl ? ((n = document.createElement("img")).setAttribute("style", "display:none;"), n.setAttribute("width", "1"), n.setAttribute("height", "1")) : ((n = document.createElement("script")).setAttribute("async", "true"), n.setAttribute("type", "text/javascript")), n.setAttribute("src", e.url), e.element = n), this.mConfig.hooks.beforeAppend instanceof Function && (e.element = this.mConfig.hooks.beforeAppend(e.element)), _(e), e.element && (e.element.tagName || e.isImgUrl)) {
                ...
                return null !== t ? t : (this.innerEvalCallDisingEvent(e), this.mState.app.actions.push(_(e)), 1)
                ...
                for (var o = 0; o < n.length; ++o) {
                    var r = n[o];
                    r.account && D(null === t.account ? void 0 : t.account, r.account) && delete r.account, i.push("p" + o + "=" + this.toQuery(r, []))
                }
                ...
                var a = d.getHighestAccessibleUrl(window),
                    a = (Fe(this.maybeRemoveQueryParams(a, t), i, t.fullUrlMaxLength, "fu", "ful"), t.isStepAllowed("readPreviousUrl") && (e = d.getPreviousUrl(window), Fe(e = this.maybeRemoveQueryParams(e, t), i, t.previousUrlMaxLength, "pu", "pul")), de.generateUUID()),
            ...
            }, L.prototype.onMessageReceived = function(n) {
                return u(this, void 0, void 0, function() {
                    var t;
                    return T(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return (t = n.data) && n.origin == this.mSyncframe.gumSyncFrameOrigin || H("BypassSyncframeMessageSanityCheck", !1) ? (n.stopPropagation(), this.mIdentification.checkCookies(t), this.mSyncframe.waitingForSyncframe ? [4, this.unblockEvents()] : [3, 2]) : [2];
                            case 1:
                                e.sent(), e.label = 2;
                            case 2:
                                return [2]
            ...
            function L() {
                var e, t, n, i, o, r, a = this,
                    s = (void 0 !== (null == (o = null === window || void 0 === window ? void 0 : window.location) ? void 0 : o.hash) && -1 !== window.location.hash.indexOf("onetag-debug") && R.setLogLevel(p.Debug), this.exceptionHandler = new j, this.exceptions = this.exceptionHandler.exceptions, this.performanceMetrics = new Pe, this.performances = this.performanceMetrics.timings, this.performanceMetrics.startRecordingInit(), this.mState = {
                        app: new Ie,
                        cbs: new Se
                ...
                this.mIdentification = s ? new me(this.exceptionHandler, c, window, this.mConfig) : new ve, this.mSyncframe = new(s ? ye : we), this.mConsentManager = new te(window), this.mAttributionReporting = new V(document, this.exceptionHandler), this.cspLogger = U.getSingleton(this.mConfig.trackingCallData.dynamic ? "dynamic.criteo.com" : "static.criteo.net", this.mConfig.trackingCallData.dynamic ? l.OneTagDynamic : l.OneTagStatic), this.pushLock = new le, this.evalQueueLock = new le, this.exceptionHandler.catchAndStoreException(function() {
                    ...
                    h("visitEventEnabled", !1) && _e(a, a.mState.app)
                })
            }
            ...
            function Ee(e) {
                var t, n;
                (!e.criteo_q || e.criteo_q instanceof Array) && (t = e.criteo_q || [], e.criteo_q = De({
                    exceptions: (n = new Ae).exceptions,
            ...
            Ee(window), O.wrapCriteoQ = Ee, Object.defineProperty(O, "__esModule", {
                value: !0
            })
        }({});
    } catch {}
