        ...
        f.ensureModuleRegistered("normalizeSignalsFBEventsPhoneNumberType", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function i(a) {
                        if (c.isInTest("fix_phone_number_format")) try {
                            return l(a)
                        } catch (c) {
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function p(a) {
                        if (a == null) return null;
                        var b = a;
                        if (g.isInTest("fix_state_normalization")) try {
                            return o(b, i)
                        } catch (a) {
                    ...
                    function q(a) {
                        a = a;
                        if (a != null && g.isInTest("fix_state_normalization")) try {
                            return o(a, h)
                        } catch (a) {
        ...
        f.ensureModuleRegistered("SignalsFBEventsCorrectPIIPlacement", function() {
            return function(g, h, j, k) {
                ...
                (function() {
                    ...
                    function n(a) {
                        if (!k.isInTest("fix_user_data_field_placement")) return a;
                        try {
        ...
        f.ensureModuleRegistered("SignalsFBEventsProcessEmailAddress", function() {
            return function(g, h, j, k) {
                ...
                (function() {
                    ...
                    function k(a) {
                        if (!h.isInTest("fix_email_address_format")) return a;
                        try {
                            if (a == null || (typeof a === "undefined" ? "undefined" : i(a)) !== "object") return a;
                            d(e(a), function(c) {
                                var d = a[c];
                                if (b(d)) return;
                                if (!j.includes(c) || d == null || typeof d != "string") return;
                                d = g(d);
